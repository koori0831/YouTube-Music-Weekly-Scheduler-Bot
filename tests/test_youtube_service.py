...
def test_search_music_uses_auto_generated_description_artist_for_release_topic(monkeypatch):
    fake = _FakeYTMusic(
        items=[
            {
                "videoId": "abc123",
    ...
    assert len(results) == 1
    assert results[0].artist == "actual artist"


def test_search_music_uses_first_auto_generated_description_artist_for_release_topic(monkeypatch):
    fake = _FakeYTMusic(
        items=[
            {
                "videoId": "abc123",
